...
Antes de rodar qualquer serviço, renomeie cada `.env.example` para `.env`. Os `.env` em `back` e `front` são necessários apenas para rodar os apps localmente, para fazer mudanças no codigo de maneira mais fácil.
